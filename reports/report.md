...
5. The [`keymatrix.cpp`](../firmware/src/keymatrix.cpp) source file is the core of our matrix scanning strategy, and respects a single shared datastructure  (mentioned below) across all operations.
